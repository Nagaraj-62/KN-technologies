...
// // Make courseTitle and mappedCourse optional by providing default empty values
// export default function EnrollmentModal({ isOpen, onClose, courseTitle = '', mappedCourse = '' }) {
//   const [submitted, setSubmitted] = useState(false);
//   const inputStyle = "w-full px-4 py-3 rounded-xl border border-gray-600 bg-gray-900 text-white focus:outline-none focus:ring-2 focus:ring-blue-400";
...
//       <div className="bg-gradient-to-br from-blue-900 via-black to-blue-800 text-white rounded-2xl shadow-2xl w-full max-w-3xl p-8 relative">
//         <button
...
//             <p className="text-gray-300 text-lg">Your enrollment has been received. We will contact you soon.</p>
//           </div>
//         ) : (
//           <form onSubmit={handleSubmit} className="space-y-6">
//             {/* ✨ CHANGE: Use a ternary operator for the title */}
...
//               {/* ... (Name, Email, Phone, Branch fields are the same) ... */}
//                <div>
...
//                 {/* ✨ CHANGE: The defaultValue will now correctly be empty if mappedCourse is not provided */}
...
//             <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 transition transform hover:scale-105 py-3 rounded-xl font-bold text-lg text-white mt-4">
//               Submit Enrollment
//             </button>
//           </form>
//         )}
